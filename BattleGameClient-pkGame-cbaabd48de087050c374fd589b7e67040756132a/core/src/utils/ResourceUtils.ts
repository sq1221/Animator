...
class ResourceUtils extends BaseClass {
     ...
     */
    public loadGroup($groupName:string, $onResourceLoadComplete:Function, $onResourceLoadProgress:Function, $onResourceLoadTarget:any, $onResourceLoadError:Function = null):void {
     ...
     * @param $onResourceLoadError 资源加载失败监听函数
     */
    public loadGroups($groupName:string, $subGroups:Array<any>, $onResourceLoadComplete:Function, $onResourceLoadProgress:Function, $onResourceLoadTarget:any, $onResourceLoadError:Function = null):void {
    ...
    private onResourceLoadError(event:RES.ResourceEvent):void {
        ...
        if (this._groups[groupName]) {
            ...
            var loadError:any = this._groups[groupName][3];
            if (loadError != null) {
