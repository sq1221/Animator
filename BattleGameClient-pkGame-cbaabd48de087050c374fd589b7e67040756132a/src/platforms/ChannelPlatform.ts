class ChannelPlatform implements IPlatform {
    ...
    private init(): void {
        //初始化统计
        let chanId = egret.getOption("chanId");
        console.log("ddddd", chanId);
        Statistics.init('Channel', "https://gameanalysis.egret.com/pk/stat.php", chanId);
        //初始化GameId
    ...
    public gameOver(value: number): void {
        ...
        //     case 0:
        //     case 1:
        //         egret.ExternalInterface.call('callNativeGameOver', '0');
        //         // window["ExternalInterface"]["call"]("callNativeGameOver", "0");
        //     case 2:
        //         egret.ExternalInterface.call('callNativeGameOver', '2');
        //         // window["ExternalInterface"]["call"]("callNativeGameOver", "2");
        //         break;
        //     case 3:
        //         egret.ExternalInterface.call('callNativeGameOver', '1');
